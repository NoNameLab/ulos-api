...
class TaskStageStatus(Model):
    ...
    processing_stage = fields.ForeignKeyField("models.ProcessingStage", related_name="tasks")
    processing_status = fields.ForeignKeyField("models.ProcessingStatus", related_name="tasks")
